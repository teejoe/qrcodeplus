...
import com.google.zxing.NativeLib;
 ...
 */
public final class AdjustedHybridBinarizer extends GlobalHistogramBinarizer {
    ...
    public AdjustedHybridBinarizer(LuminanceSource source) {
        super(source);
    }

    public AdjustedHybridBinarizer(LuminanceSource source, float scaleFactor) {
        super(source);
    ...
    public BitMatrix getBlackMatrix() throws NotFoundException {
        ...
        if (width >= MINIMUM_DIMENSION && height >= MINIMUM_DIMENSION) {
            ...
            if (DecodeConfigs.USE_NATIVE_METHODS) {
                ...
                NativeLib.calculateThresholdForBlock(luminances, subWidth, subHeight, width, height,
                        scaleFactor, newMatrix.getBits());
                matrix = newMatrix;
            } else {
    ...
    public Binarizer createBinarizer(LuminanceSource source) {
        return new AdjustedHybridBinarizer(source);
    }
